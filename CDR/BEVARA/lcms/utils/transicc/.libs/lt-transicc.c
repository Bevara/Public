...
/* ./.libs/lt-transicc.c - temporary wrapper executable for .libs/transicc
   Generated by libtool (GNU libtool) 2.4.2

   The transicc program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/lcms2-2.9/src/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/lcms2-2.9/src/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "transicc"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# transicc - temporary wrapper script for .libs/transicc\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The transicc program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../src/liblcms2.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"transicc:transicc:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"transicc:transicc:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"transicc:transicc:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/lcms2-2.9/src/.l", f);
  fputs ("ibs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/lcms2-2.9/src/.", f);
  fputs ("libs:$PATH\"\n", f);
  fputs ("\n", f);
