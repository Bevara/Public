...
/* ./.libs/lt-scaling-helpers-test.c - temporary wrapper executable for .libs/scaling-helpers-test
   Generated by libtool (GNU libtool) 2.4.6

   The scaling-helpers-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "scaling-helpers-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# scaling-helpers-test - temporary wrapper script for .libs/scaling-helpers-tes", f);
  fputs ("t\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The scaling-helpers-test program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("    echo \"scaling-helpers-test:scaling-helpers-test:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"scaling-helpers-test:scaling-helpers-test:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"scaling-helpers-test:scaling-helpers-test:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='scaling-helpers-test'\n", f);
