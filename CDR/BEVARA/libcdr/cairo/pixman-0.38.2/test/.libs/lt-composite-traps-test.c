...
/* ./.libs/lt-composite-traps-test.c - temporary wrapper executable for .libs/composite-traps-test
   Generated by libtool (GNU libtool) 2.4.6

   The composite-traps-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "composite-traps-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# composite-traps-test - temporary wrapper script for .libs/composite-traps-tes", f);
  fputs ("t\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The composite-traps-test program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("    echo \"composite-traps-test:composite-traps-test:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"composite-traps-test:composite-traps-test:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"composite-traps-test:composite-traps-test:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='composite-traps-test'\n", f);
