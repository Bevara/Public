...
/* ./.libs/lt-radial-invalid.c - temporary wrapper executable for .libs/radial-invalid
   Generated by libtool (GNU libtool) 2.4.6

   The radial-invalid program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "radial-invalid"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# radial-invalid - temporary wrapper script for .libs/radial-invalid\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The radial-invalid program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"radial-invalid:radial-invalid:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"radial-invalid:radial-invalid:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"radial-invalid:radial-invalid:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
