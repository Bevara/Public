...
/* ./.libs/lt-lowlevel-blt-bench.c - temporary wrapper executable for .libs/lowlevel-blt-bench
   Generated by libtool (GNU libtool) 2.4.6

   The lowlevel-blt-bench program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "lowlevel-blt-bench"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# lowlevel-blt-bench - temporary wrapper script for .libs/lowlevel-blt-bench\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The lowlevel-blt-bench program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"lowlevel-blt-bench:lowlevel-blt-bench:$LINENO: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lowlevel-blt-bench:lowlevel-blt-bench:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lowlevel-blt-bench:lowlevel-blt-bench:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='lowlevel-blt-bench'\n", f);
