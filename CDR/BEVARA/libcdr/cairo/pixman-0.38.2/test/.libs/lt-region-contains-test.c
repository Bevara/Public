...
/* ./.libs/lt-region-contains-test.c - temporary wrapper executable for .libs/region-contains-test
   Generated by libtool (GNU libtool) 2.4.6

   The region-contains-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "region-contains-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# region-contains-test - temporary wrapper script for .libs/region-contains-tes", f);
  fputs ("t\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The region-contains-test program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("    echo \"region-contains-test:region-contains-test:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"region-contains-test:region-contains-test:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"region-contains-test:region-contains-test:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='region-contains-test'\n", f);
