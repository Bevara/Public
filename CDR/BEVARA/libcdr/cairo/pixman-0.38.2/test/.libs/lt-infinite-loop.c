...
/* ./.libs/lt-infinite-loop.c - temporary wrapper executable for .libs/infinite-loop
   Generated by libtool (GNU libtool) 2.4.6

   The infinite-loop program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "infinite-loop"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# infinite-loop - temporary wrapper script for .libs/infinite-loop\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The infinite-loop program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"infinite-loop:infinite-loop:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"infinite-loop:infinite-loop:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"infinite-loop:infinite-loop:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
