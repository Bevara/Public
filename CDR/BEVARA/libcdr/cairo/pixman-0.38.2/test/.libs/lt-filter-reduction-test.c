...
/* ./.libs/lt-filter-reduction-test.c - temporary wrapper executable for .libs/filter-reduction-test
   Generated by libtool (GNU libtool) 2.4.6

   The filter-reduction-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "filter-reduction-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# filter-reduction-test - temporary wrapper script for .libs/filter-reduction-t", f);
  fputs ("est\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The filter-reduction-test program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("    echo \"filter-reduction-test:filter-reduction-test:$LINENO: libtool wrapper ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"filter-reduction-test:filter-reduction-test:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"filter-reduction-test:filter-reduction-test:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='filter-reduction-test'\n", f);
