...
/* ./.libs/lt-gradient-crash-test.c - temporary wrapper executable for .libs/gradient-crash-test
   Generated by libtool (GNU libtool) 2.4.6

   The gradient-crash-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gradient-crash-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gradient-crash-test - temporary wrapper script for .libs/gradient-crash-test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The gradient-crash-test program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"gradient-crash-test:gradient-crash-test:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gradient-crash-test:gradient-crash-test:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gradient-crash-test:gradient-crash-test:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='gradient-crash-test'\n", f);
