...
/* ./.libs/lt-matrix-test.c - temporary wrapper executable for .libs/matrix-test
   Generated by libtool (GNU libtool) 2.4.6

   The matrix-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "matrix-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# matrix-test - temporary wrapper script for .libs/matrix-test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The matrix-test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"matrix-test:matrix-test:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"matrix-test:matrix-test:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"matrix-test:matrix-test:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
