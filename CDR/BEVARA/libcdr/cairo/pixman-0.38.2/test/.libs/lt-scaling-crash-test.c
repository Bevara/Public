...
/* ./.libs/lt-scaling-crash-test.c - temporary wrapper executable for .libs/scaling-crash-test
   Generated by libtool (GNU libtool) 2.4.6

   The scaling-crash-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "scaling-crash-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# scaling-crash-test - temporary wrapper script for .libs/scaling-crash-test\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The scaling-crash-test program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"scaling-crash-test:scaling-crash-test:$LINENO: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"scaling-crash-test:scaling-crash-test:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"scaling-crash-test:scaling-crash-test:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='scaling-crash-test'\n", f);
