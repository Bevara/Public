...
/* ./.libs/lt-region-translate-test.c - temporary wrapper executable for .libs/region-translate-test
   Generated by libtool (GNU libtool) 2.4.6

   The region-translate-test program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/libcdr-exper/cairo/pixman-0.38.2/pixman/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/libcdr-exper/cairo/pixman-0.38.2/pixman/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "region-translate-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# region-translate-test - temporary wrapper script for .libs/region-translate-t", f);
  fputs ("est\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The region-translate-test program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../pixman/libpixman-1.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"region-translate-test:region-translate-test:$LINENO: libtool wrapper ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"region-translate-test:region-translate-test:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"region-translate-test:region-translate-test:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='region-translate-test'\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/libcdr-exper/cai", f);
  fputs ("ro/pixman-0.38.2/pixman/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/libcdr-exper/ca", f);
  fputs ("iro/pixman-0.38.2/pixman/.libs:$PATH\"\n", f);
  fputs ("\n", f);
