...
/* ./.libs/lt-trap-crasher.c - temporary wrapper executable for .libs/trap-crasher
   Generated by libtool (GNU libtool) 2.4.6

   The trap-crasher program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "trap-crasher"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# trap-crasher - temporary wrapper script for .libs/trap-crasher\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The trap-crasher program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"trap-crasher:trap-crasher:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"trap-crasher:trap-crasher:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"trap-crasher:trap-crasher:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
