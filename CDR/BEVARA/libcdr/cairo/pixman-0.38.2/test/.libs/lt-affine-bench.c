...
/* ./.libs/lt-affine-bench.c - temporary wrapper executable for .libs/affine-bench
   Generated by libtool (GNU libtool) 2.4.6

   The affine-bench program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "affine-bench"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# affine-bench - temporary wrapper script for .libs/affine-bench\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The affine-bench program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"affine-bench:affine-bench:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"affine-bench:affine-bench:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"affine-bench:affine-bench:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
