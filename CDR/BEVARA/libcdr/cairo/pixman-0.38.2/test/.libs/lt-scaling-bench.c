...
/* ./.libs/lt-scaling-bench.c - temporary wrapper executable for .libs/scaling-bench
   Generated by libtool (GNU libtool) 2.4.6

   The scaling-bench program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "scaling-bench"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# scaling-bench - temporary wrapper script for .libs/scaling-bench\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The scaling-bench program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"scaling-bench:scaling-bench:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"scaling-bench:scaling-bench:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"scaling-bench:scaling-bench:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
