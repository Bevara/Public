...
/* ./.libs/lt-fence-image-self-test.c - temporary wrapper executable for .libs/fence-image-self-test
   Generated by libtool (GNU libtool) 2.4.6

   The fence-image-self-test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "fence-image-self-test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fence-image-self-test - temporary wrapper script for .libs/fence-image-self-t", f);
  fputs ("est\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The fence-image-self-test program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("    echo \"fence-image-self-test:fence-image-self-test:$LINENO: libtool wrapper ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fence-image-self-test:fence-image-self-test:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fence-image-self-test:fence-image-self-test:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='fence-image-self-test'\n", f);
