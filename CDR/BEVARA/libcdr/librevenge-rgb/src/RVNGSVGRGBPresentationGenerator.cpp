...
using namespace PresentationSVGRGB;

struct RVNGSVGRGBPresentationGeneratorImpl
{
	RVNGSVGRGBPresentationGeneratorImpl(RVNGStringVector &m_vec);
...
RVNGSVGRGBPresentationGeneratorImpl::RVNGSVGRGBPresentationGeneratorImpl(RVNGStringVector &vec)
	: m_idSpanMap()
	, m_gradient()
	, m_style()
	, m_gradientIndex(1)
...
RVNGSVGRGBPresentationGenerator::RVNGSVGRGBPresentationGenerator(RVNGStringVector &vec)
	: m_impl(new RVNGSVGRGBPresentationGeneratorImpl(vec))
{
}

RVNGSVGRGBPresentationGenerator::~RVNGSVGRGBPresentationGenerator()
{
	delete m_impl;
}

void RVNGSVGRGBPresentationGenerator::startDocument(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::endDocument()
{
}

void RVNGSVGRGBPresentationGenerator::setDocumentMetaData(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::defineEmbeddedFont(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::startSlide(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::endSlide()
{
...
void RVNGSVGRGBPresentationGenerator::startMasterSlide(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::endMasterSlide()
{
	if (m_impl->m_masterName.empty())
	{
...
void RVNGSVGRGBPresentationGenerator::setSlideTransition(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::setStyle(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::startLayer(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::endLayer()
{
	m_impl->m_outputSink << "</svg:g>\n";
}

void RVNGSVGRGBPresentationGenerator::startEmbeddedGraphics(const RVNGPropertyList & /*propList*/)
{
}

void RVNGSVGRGBPresentationGenerator::endEmbeddedGraphics()
{
}

void RVNGSVGRGBPresentationGenerator::openGroup(const RVNGPropertyList &/*propList*/)
{
	// TODO: handle svg:id
	m_impl->m_outputSink << "<svg:g>\n";
}

void RVNGSVGRGBPresentationGenerator::closeGroup()
{
	m_impl->m_outputSink << "</svg:g>\n";
}

void RVNGSVGRGBPresentationGenerator::drawRectangle(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::drawEllipse(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::drawPolyline(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::drawPolygon(const RVNGPropertyList &propList)
{
	const RVNGPropertyListVector *vertices = propList.child("svg:points");
	if (vertices && vertices->count())
...
void RVNGSVGRGBPresentationGeneratorImpl::drawPolySomething(const RVNGPropertyListVector &vertices, bool isClosed)
{
	if (vertices.count() < 2)
		return;
...
void RVNGSVGRGBPresentationGenerator::drawPath(const RVNGPropertyList &propList)
{
	
	printf("using the presentation generator...\n");
...
void RVNGSVGRGBPresentationGenerator::drawGraphicObject(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::drawConnector(const RVNGPropertyList &/*propList*/)
{
	// TODO: implement me
}

void RVNGSVGRGBPresentationGenerator::startTextObject(const RVNGPropertyList &propList)
{
	double x = 0.0;
	double y = 0.0;
	double height = 0.0;
...
void RVNGSVGRGBPresentationGenerator::endTextObject()
{
	m_impl->m_outputSink << "</svg:text>\n";
}

void RVNGSVGRGBPresentationGenerator::defineCharacterStyle(const RVNGPropertyList &propList)
{
...
void RVNGSVGRGBPresentationGenerator::openSpan(const RVNGPropertyList &propList)
{
	RVNGPropertyList pList(propList);
	if (propList["librevenge:span-id"] &&
...
void RVNGSVGRGBPresentationGenerator::closeSpan()
{
	m_impl->m_outputSink << "</svg:tspan>\n";
}

void RVNGSVGRGBPresentationGenerator::openLink(const RVNGPropertyList & /* propList */)
{
}

void RVNGSVGRGBPresentationGenerator::closeLink()
{
}

void RVNGSVGRGBPresentationGenerator::insertTab()
{
	m_impl->m_outputSink << '\t';
}

void RVNGSVGRGBPresentationGenerator::insertSpace()
{
	m_impl->m_outputSink << ' ';
}

void RVNGSVGRGBPresentationGenerator::insertText(const RVNGString &str)
{
	m_impl->m_outputSink << RVNGString::escapeXML(str).cstr() << "\n";
}

void RVNGSVGRGBPresentationGenerator::insertLineBreak()
{
	m_impl->m_outputSink << '\n';
}

void RVNGSVGRGBPresentationGenerator::insertField(const RVNGPropertyList &/*propList*/)
{
	// TODO: implement me
}

void RVNGSVGRGBPresentationGenerator::openOrderedListLevel(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::openUnorderedListLevel(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeOrderedListLevel()
{
}

void RVNGSVGRGBPresentationGenerator::closeUnorderedListLevel()
{
}

void RVNGSVGRGBPresentationGenerator::openListElement(const RVNGPropertyList &propList)
{
	openParagraph(propList);
}

void RVNGSVGRGBPresentationGenerator::closeListElement()
{
	closeParagraph();
}

void RVNGSVGRGBPresentationGenerator::defineParagraphStyle(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::openParagraph(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeParagraph()
{
	m_impl->m_outputSink << '\n';
}

void RVNGSVGRGBPresentationGenerator::startTableObject(const RVNGPropertyList &propList)
{
	if (m_impl->m_table)
	{
...
void RVNGSVGRGBPresentationGenerator::openTableRow(const RVNGPropertyList &propList)
{
	if (!m_impl->m_table) return;
	m_impl->m_table->openRow(propList);
}

void RVNGSVGRGBPresentationGenerator::closeTableRow()
{
	if (!m_impl->m_table) return;
	m_impl->m_table->closeRow();
}

void RVNGSVGRGBPresentationGenerator::openTableCell(const RVNGPropertyList &propList)
{
	if (!m_impl->m_table) return;
...
void RVNGSVGRGBPresentationGenerator::closeTableCell()
{
	if (!m_impl->m_table) return;
	m_impl->m_outputSink << "</svg:text>\n";
}

void RVNGSVGRGBPresentationGenerator::insertCoveredTableCell(const RVNGPropertyList &/*propList*/)
{
	if (!m_impl->m_table) return;
	// TODO: implement me
}

void RVNGSVGRGBPresentationGenerator::endTableObject()
{
	if (!m_impl->m_table)
	{
...
void RVNGSVGRGBPresentationGenerator::startComment(const RVNGPropertyList &/*propList*/)
{
	// TODO: implement me
}

void RVNGSVGRGBPresentationGenerator::endComment()
{
	// TODO: implement me
}


void RVNGSVGRGBPresentationGenerator::startNotes(const RVNGPropertyList &/*propList*/)
{
	// TODO: implement me
}

void RVNGSVGRGBPresentationGenerator::endNotes()
{
	// TODO: implement me
}

void RVNGSVGRGBPresentationGenerator::defineChartStyle(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::openChart(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeChart()
{
}

void RVNGSVGRGBPresentationGenerator::openChartTextObject(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeChartTextObject()
{
}

void RVNGSVGRGBPresentationGenerator::openChartPlotArea(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeChartPlotArea()
{
}

void RVNGSVGRGBPresentationGenerator::insertChartAxis(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::openChartSeries(const librevenge::RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeChartSeries()
{
}

// create "style" attribute based on current pen and brush
void RVNGSVGRGBPresentationGeneratorImpl::writeStyle(bool /* isClosed */)
{
	m_outputSink << "style=\"";
...
void RVNGSVGRGBPresentationGenerator::openAnimationSequence(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeAnimationSequence()
{
}

void RVNGSVGRGBPresentationGenerator::openAnimationGroup(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeAnimationGroup()
{
}

void RVNGSVGRGBPresentationGenerator::openAnimationIteration(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::closeAnimationIteration()
{
}

void RVNGSVGRGBPresentationGenerator::insertMotionAnimation(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::insertColorAnimation(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::insertAnimation(const RVNGPropertyList &)
{
}

void RVNGSVGRGBPresentationGenerator::insertEffect(const RVNGPropertyList &)
{
}
