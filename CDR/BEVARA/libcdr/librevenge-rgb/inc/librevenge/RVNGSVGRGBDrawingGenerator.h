...
#ifndef RVNGSVGRGBDRAWINGGENERATOR_H
#define RVNGSVGRGBDRAWINGGENERATOR_H
...
class REVENGE_API RVNGSVGRGBDrawingGenerator : public RVNGDrawingInterface
{
public:
	RVNGSVGRGBDrawingGenerator(RVNGStringVector &vec, unsigned char *rgbaOutbuf, int *rgbaOutWidth, int *rgbaOutHeight,int *nsFeatures, const RVNGString &nmspace);
	~RVNGSVGRGBDrawingGenerator();
...
private:
	RVNGSVGRGBDrawingGenerator(const RVNGSVGRGBDrawingGenerator &);
	RVNGSVGRGBDrawingGenerator &operator=(const RVNGSVGRGBDrawingGenerator &);
	RVNGSVGRGBDrawingGeneratorPrivate *m_pImpl;
};
