...
#ifndef RVNGSVGRGBPRESENTATIONGENERATOR_H
#define RVNGSVGRGBPRESENTATIONGENERATOR_H
...
class REVENGE_GENERATORS_API RVNGSVGRGBPresentationGenerator : public RVNGPresentationInterface
{
	// disable copying
	RVNGSVGRGBPresentationGenerator(const RVNGSVGRGBPresentationGenerator &other);
	RVNGSVGRGBPresentationGenerator &operator=(const RVNGSVGRGBPresentationGenerator &other);

public:
	explicit RVNGSVGRGBPresentationGenerator(RVNGStringVector &vec);
	~RVNGSVGRGBPresentationGenerator();
...
private:
	RVNGSVGRGBPresentationGeneratorImpl *m_impl;
};
