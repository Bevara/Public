...
/* ./.libs/lt-cdr2xhtml.c - temporary wrapper executable for .libs/cdr2xhtml
   Generated by libtool (GNU libtool) 2.4.6

   The cdr2xhtml program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "cdr2xhtml"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# cdr2xhtml - temporary wrapper script for .libs/cdr2xhtml\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The cdr2xhtml program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("al/lib/librevenge-0.0.la /usr/local/lib/librevenge-stream-0.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"cdr2xhtml:cdr2xhtml:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"cdr2xhtml:cdr2xhtml:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"cdr2xhtml:cdr2xhtml:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
