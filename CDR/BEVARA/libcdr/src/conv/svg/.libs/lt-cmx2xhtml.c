...
/* ./.libs/lt-cmx2xhtml.c - temporary wrapper executable for .libs/cmx2xhtml
   Generated by libtool (GNU libtool) 2.4.6

   The cmx2xhtml program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/libcdr/src/lib/.libs:/usr/local/lib:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/local/lib:/usr/local/bin:/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/libcdr/src/lib/.libs:";
const char * TARGET_PROGRAM_NAME = "cmx2xhtml"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# cmx2xhtml - temporary wrapper script for .libs/cmx2xhtml\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The cmx2xhtml program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../lib/libcdr-0.1.la /usr/local/lib/liblcms2.la /usr/loc", f);
  fputs ("al/lib/librevenge-generators-0.0.la /usr/local/lib/librevenge-0.0.la /usr/local", f);
  fputs ("/lib/librevenge-stream-0.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"cmx2xhtml:cmx2xhtml:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"cmx2xhtml:cmx2xhtml:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"cmx2xhtml:cmx2xhtml:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/usr/local/lib:/usr/local/bin:/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EX", f);
  fputs ("PER/CORELDRAW/libcdr/src/lib/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/mydocs/BEVARA/DEVELOPMENT/EXPER/CORELDRAW/libcdr/src/lib/", f);
  fputs (".libs:/usr/local/lib:$PATH\"\n", f);
  fputs ("\n", f);
