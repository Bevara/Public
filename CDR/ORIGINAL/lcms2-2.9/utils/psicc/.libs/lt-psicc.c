...
/* ./.libs/lt-psicc.c - temporary wrapper executable for .libs/psicc
   Generated by libtool (GNU libtool) 2.4.2

   The psicc program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "psicc"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# psicc - temporary wrapper script for .libs/psicc\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The psicc program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"psicc:psicc:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"psicc:psicc:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"psicc:psicc:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
