...
#define FT_COMPONENT  trace_objs
                      ...
                      FT_Size_Request  req )
  {
    ...
    if ( FT_IS_SCALABLE( face ) )
    {
      ...
      printf("setting req widthand height\n");
  ...
  Calculate_Ppem:
	...
	printf("try mulfix\n");
      ...
      printf("is nominal req\n");

      metrics->x_ppem = (FT_UShort)( ( scaled_w + 32 ) >> 6 );
      metrics->y_ppem = (FT_UShort)( ( scaled_h + 32 ) >> 6 );

      printf("recompute scaled metrics\n");
      ft_recompute_scaled_metrics( face, metrics );
    }
    else
    {
                   ...
                   FT_Size_Request  req )
  {
    ...
    printf("skipping request size\n");


    if ( clazz->request_size )
    {
      FT_Error  error;
      printf("goto request size\n");
    ...
    printf("no request size impl\n");

    printf("scaable = %d fixed = %d\n",FT_IS_SCALABLE( face ),FT_HAS_FIXED_SIZES( face ));
    ...
    if ( (!FT_IS_SCALABLE( face )) && FT_HAS_FIXED_SIZES( face ) ) 
    {
      ...
      FT_TRACE3(( "FT_Request_Size: bitmap strike %lu matched\n",
                  strike_index ));
      printf("to select size\n");

      return FT_Select_Size( face, (FT_Int)strike_index );
    }

    printf("to request metrics\n");
                    ...
                    FT_UInt     vert_resolution )
  {
    ...
    printf("heading to request size\n");
...
#define FREETYPE_VER_FIXED  ( ( (FT_Long)FREETYPE_MAJOR << 16 ) | \
                          ...
                          FT_UInt     vert_res )
  {
    ...
    printf("config option old internals set\n");
