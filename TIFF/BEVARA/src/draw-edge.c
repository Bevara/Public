...
fz_insert_gel_raw(fz_gel *gel, int x0, int y0, int x1, int y1)
{
	...
	printf("in gel raw - resize array\n");
...
fz_insert_gel(fz_gel *gel, float fx0, float fy0, float fx1, float fy1)
{
	...
	/* fx0 = floorf((float)(fx0 *(float) fz_aa_hscale)); */
	/* fx1 = floorf((float)(fx1 *(float) fz_aa_hscale)); */
	/* fy0 = floorf((float)(fy0 * (float)fz_aa_vscale)); */
	/* fy1 = floorf((float)(fy1 *(float) fz_aa_vscale)); */

	/* exchanged for myfloorf*/
	fx0 = myfloorf((float)(fx0 *(float) fz_aa_hscale));
	fx1 = myfloorf((float)(fx1 *(float) fz_aa_hscale));
	fy0 = myfloorf((float)(fy0 * (float)fz_aa_vscale));
	fy1 = myfloorf((float)(fy1 *(float) fz_aa_vscale));

	printf("doign float-domain clamping\n");
